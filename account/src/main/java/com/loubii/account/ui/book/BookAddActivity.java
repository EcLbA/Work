package com.loubii.account.ui.book;
...
import com.loubii.account.ui.card.CardBelongActivity;
...
public class BookAddActivity extends BaseToolBarActivity {
...
/*    private DaoMaster mDaoMaster;
    ...
    //adapter add display
        ...
        public void dataInsert(BookBean data) {
            mDaoSession.getBookBeanDao().insert(data);
        }

        public void addAdapter(BookBean data){
